...
def get_value(s, weights):
    ...
    ### START CODE HERE ###
    x = my_matmul(s,weights[0]['W']) + weights[0]['b']
    x[x < 0] = 0
...
class TDAgent(BaseAgent):
    ...
    def agent_step(self, reward, state):
        ...
        ### START CODE HERE ###
        oh = one_hot(state,self.num_states)
        loh = one_hot(self.last_state,self.num_states)
        delta = reward + self.discount_factor * get_value(oh,self.weights)  - get_value(loh,self.weights)
        ### END CODE HERE ###
        ...
        ### START CODE HERE ###
        grads = get_gradient(loh, self.weights)
        ### END CODE HERE ###
    ...
    def agent_end(self, reward):
        ...
        ### START CODE HERE ###
        loh = one_hot(self.last_state,self.num_states)
        delta = reward - get_value(loh,self.weights)
        ### END CODE HERE ###
